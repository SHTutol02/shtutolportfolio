        ...
        <div className="mt-16 space-y-12">
          ...
          <section className="bg-slate-900/50 p-8 rounded-3xl border border-white/5">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className="px-4 py-2 bg-[#0B111F] border border-white/10 rounded-lg text-slate-300 font-medium">Adobe XD</span>
              <span className="px-4 py-2 bg-[#0B111F] border border-white/10 rounded-lg text-slate-300 font-medium">Protopie</span>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-12">
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
                <div className="rounded-2xl overflow-hidden mb-8 border border-white/10">
                  <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&q=80&w=800" alt="Gallery item" className="w-full h-auto object-cover max-h-[800px]" />
                </div>
                <div className="px-2">
                  <h3 className="text-lg font-bold text-white mb-2">Description</h3>
                  <p className="text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
                    Initial wireframes and concept design for the mobile interface.
                  </p>
                </div>
              </div>
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
