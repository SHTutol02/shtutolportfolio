        ...
        <div className="mt-16 space-y-12">
          <section>
            ...
            <p className="text-slate-400 text-lg leading-relaxed whitespace-pre-line">
              This brand identity project focuses on creating a minimal and modern logo and branding materials. The goal was to establish a strong, recognizable corporate identity that stands out in a competitive market.
            </p>
          </section>
            ...
            <div className="flex flex-col gap-12">
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
                <div className="rounded-2xl overflow-hidden mb-8 border border-white/10">
                  <img src="https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&q=80&w=800" alt="Gallery item" className="w-full h-auto object-cover max-h-[800px]" />
                </div>
                <div className="px-2">
                  <h3 className="text-lg font-bold text-white mb-2">Description</h3>
                  <p className="text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
                    Logo design draft 1, showing a modern clean aesthetic.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
                <div className="rounded-2xl overflow-hidden mb-8 border border-white/10">
                  <img src="https://images.unsplash.com/photo-1600132806370-bf17e65e942f?auto=format&fit=crop&q=80&w=800" alt="Gallery item" className="w-full h-auto object-cover max-h-[800px]" />
                </div>
                <div className="px-2">
                  <h3 className="text-lg font-bold text-white mb-2">Description</h3>
                  <p className="text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
                    Finalized letterhead and business card mockup.
                  </p>
                </div>
              </div>
            </div>
