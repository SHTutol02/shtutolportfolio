  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto px-6 pt-16">
        <span className="text-rose-400 font-bold tracking-widest text-sm uppercase mb-4 block">Illustrator & Layout</span>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">Corporate Presentation</h1>
        <div className="mt-12 w-full rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-slate-900 aspect-video relative">
          <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=800" alt="Corporate Presentation" className="w-full h-full object-cover" />
        </div>
        <div className="mt-16 space-y-12">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Project Overview</h2>
            <p className="text-slate-400 text-lg leading-relaxed whitespace-pre-line">
              Design of a clean, highly professional corporate pitch deck used for stakeholder meetings and annual reviews.
            </p>
          </section>
          <section className="bg-slate-900/50 p-8 rounded-3xl border border-white/5">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="px-4 py-2 bg-[#0B111F] border border-white/10 rounded-lg text-slate-300 font-medium">Microsoft PowerPoint</span>
              <span className="px-4 py-2 bg-[#0B111F] border border-white/10 rounded-lg text-slate-300 font-medium">Adobe Illustrator</span>
              <span className="px-4 py-2 bg-[#0B111F] border border-white/10 rounded-lg text-slate-300 font-medium">Keynote</span>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-12">
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
                <div className="rounded-2xl overflow-hidden mb-8 border border-white/10">
                  <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=800" alt="Gallery item" className="w-full h-auto object-cover max-h-[800px]" />
                </div>
                <div className="px-2">
                  <h3 className="text-lg font-bold text-white mb-2">Description</h3>
                  <p className="text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
                    Key presentation slide focusing on corporate growth and milestones.
                  </p>
                </div>
              </div>
              <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-xl">
                <div className="rounded-2xl overflow-hidden mb-8 border border-white/10">
                  <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800" alt="Gallery item" className="w-full h-auto object-cover max-h-[800px]" />
                </div>
                <div className="px-2">
                  <h3 className="text-lg font-bold text-white mb-2">Description</h3>
                  <p className="text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
                    Data visualization slide showcasing financial performance in a clean layout.
                  </p>
                </div>
              </div>
            </div>
